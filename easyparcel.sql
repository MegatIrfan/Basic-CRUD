...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2023 at 09:06 AM
...
-- Insert 50 dummy records into easyparcel table
INSERT INTO `easyparcel` (`name_parcel`, `date_received`, `courier`, `tracking_num`)
VALUES
    ...
    ('David Brown', '2023-08-16 14:30:00', 'POSLAJU EXPRESS', 567890),
...
--
-- Indexes for table `easyparcel`
--
ALTER TABLE `easyparcel`
  ADD PRIMARY KEY (`name_parcel`);
COMMIT;
